  ...
  auth.onAuthStateChanged(async (user) => {
    ...
    if (data && data.accountStatus === "active") {
      ...
      if (!document.querySelector("#baa-menu-btn")) {
        ...
        menuBtn.style.cssText = "position:fixed;top:12px;right:12px;z-index:99999;width:44px;height:44px;border-radius:50%;background:#f3e7d3;border:1px solid rgba(200,169,107,0.5);cursor:pointer;display:flex;align-items:center;justify-content:center;box-shadow:0 2px 8px rgba(200,169,107,0.3);overflow:hidden;";
