function openDiagnosticPeau() {
  ...
  function renderAnalyse() {
    ...
    var stepInterval = setInterval(function() {
      ...
      if (barEl) barEl.style.width = ((currentStep+1)/steps.length*90) + "%";
    }, 1200);
  }
