  ...
  auth.onAuthStateChanged(async (user) => {
    ...
    if (data && data.accountStatus === "active") {
      ...
      function openOutilsPanel() {
        ...
        document.getElementById("outil-tab-generateur").onclick = function() { panel.remove(); if (typeof openGenerateurVisuels === "function") openGenerateurVisuels(); };
